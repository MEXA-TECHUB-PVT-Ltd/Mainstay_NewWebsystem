...
const CoachChat = () => {
  ...
  // const [selectedContact, setSelectedContact] = useState(receiverId ? { contact_id: receiverId, contact_first_name: "ReceiverFirstName", contact_last_name: "ReceiverLastName", profile_pic: "ReceiverProfileImageURL" } : null);
  ...
  const fetchMessages = (receiverId) => {
    ...
    const targetReceiverId = receiverId || selectedContact?.contact_id;
    if (targetReceiverId) {
  ...
  //     console.log("Fetched userId:", loginUserData.user.id);
  //     setUserId(parseInt(loginUserData.user.id)); // Set userId state if loginUserData is available
  //   } else {
      ...
      {isLoading ? (
        ...
        <>
          ...
          <Modal isOpen={modal} toggle={toggle}>
            ...
            <ModalBody>Do you want to report this user?</ModalBody>
            <ModalFooter>
          ...
          <Modal isOpen={deletmodal} toggle={deletetoggle}>
            <ModalHeader toggle={deletetoggle}>Delete Chat</ModalHeader>
